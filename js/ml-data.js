...
const ML_KM_DATASET = {
  ...
  points: [
    // 좌상단 동네
    [16, 76], [22, 80], [18, 73], [24, 78], [20, 83], [14, 79],
    // 우상단 동네
    [78, 76], [83, 81], [76, 80], [85, 78], [80, 73], [82, 84],
    // 한가운데 동네
    [48, 48], [53, 52], [50, 45], [45, 52], [55, 50], [50, 55],
    // 좌하단 동네
    [20, 22], [25, 27], [17, 26], [23, 19], [27, 24], [18, 21],
    // 우하단 동네
    [78, 23], [83, 28], [76, 27], [85, 23], [80, 30], [82, 20],
  ].map(([x, y]) => ({ x, y })),
};
