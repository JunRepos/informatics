...
/* ═══════════════════════════════════════
   🎯 k-평균 데이터셋 (지도 위 손님 위치 — 가까운 손님끼리 k개 구역으로)
   2D로 골고루 흩어진 5개 무리(30점). 빈 군집이 안 생기도록 분포·개수 설계.
═══════════════════════════════════════ */
const ML_KM_DATASET = {
  xLabel: '가로 위치', xUnit: '', yLabel: '세로 위치', yUnit: '',
  // 지도에 고르게 흩어진 손님 위치(32명). 미리 군집이 보이지 않도록 자연스러운 분포.
  points: [
    [10, 15], [26, 9], [41, 18], [57, 12], [73, 16], [88, 24],
    [17, 31], [33, 25], [50, 34], [67, 27], [83, 38],
    [9, 46], [24, 41], [43, 48], [61, 43], [79, 52], [91, 49],
    [15, 59], [31, 64], [49, 56], [69, 65], [85, 61],
    [11, 73], [28, 79], [46, 71], [64, 81], [81, 76], [90, 87],
    [21, 89], [38, 91], [56, 88], [74, 90],
  ].map(([x, y]) => ({ x, y })),
};
