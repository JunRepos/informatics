...
const MLP_LIST = [
  /* ═══════ 메인 (전원 공통) ═══════ */
  {
    ...
    mlNeeded: true,
    dossier: {
      org: '🏛️ 해양역사박물관 · 디지털 복원 프로젝트팀',
      scene: '1912년 4월, 첫 항해에 나선 초호화 여객선 <b>타이타닉호</b>는 빙산과 충돌해 침몰했습니다. 100년이 더 지난 지금, 박물관은 흩어진 승객들의 기록을 디지털로 되살리는 복원 프로젝트를 진행하고 있어요. 그런데 사고 직후의 혼란 속에 일부 승객은 <b>명단 정보는 남았지만 생존 여부 기록이 유실</b>됐습니다. 유족에게 전할 기록과 추모 전시를 위해, 박물관은 이 승객들이 살아남았는지를 추정하려 합니다.',
      data: '생존 여부가 <b>확인된</b> 승객들의 기록 — 성별 · 나이 · 객실 등급 · 동승 가족 수, 그리고 <b>생존/사망</b>',
      ask: '명단 정보만 남은 승객들의 <b>생존 여부</b>를 추정하기',
    },
    brief: [
  ...
  /* ═══════ 확장 ①: 분류 · 보건/의료 ═══════ */
  {
    ...
    dossier: {
      org: '🏥 행복시 보건소 · 건강증진팀',
      scene: '행복시 보건소는 해마다 수천 명의 주민에게 건강검진을 제공하고, 그 기록이 수년째 차곡차곡 쌓였습니다. 하지만 판정을 내릴 의사는 단 한 분뿐이라 모든 검진자를 깊이 들여다보기는 어려워요. 큰 병일수록 일찍 발견하는 것이 중요한데, <b>정밀검사가 필요한 사람을 미리 골라낼 방법</b>이 없어 늘 아쉬웠습니다. 보건소는 그동안 쌓아 온 검진 기록을 활용해 보기로 했어요.',
      data: '주민들의 과거 검진 기록 — 나이 · BMI · 수축기 혈압 · 주당 운동 횟수, 그리고 의사가 판정한 <b>위험군/정상</b>',
      ask: '새 검진자가 <b>위험군인지</b> 미리 가려내 정밀검사를 안내하기',
    },
    brief: [
  ...
  /* ═══════ 확장 ②: 회귀 · 스포츠 ═══════ */
  {
    ...
    mlNeeded: true,
    dossier: {
      org: '🏃 우리학교 육상부 · 데이터 코치진',
      scene: '다음 달 큰 대회를 앞둔 육상부. 최강속 코치는 1년 동안 부원 한 명 한 명의 훈련과 컨디션을 <b>기록부</b>에 빠짐없이 적어 왔습니다. 이제 부원별로 훈련 계획을 세워야 하는데, "이 친구가 이렇게 훈련하면 기록이 얼마나 나올까?"를 <b>감이 아니라 데이터로</b> 알고 싶어요. 기록부에는 부원들의 조건과 실제 기록이 짝지어 쌓여 있습니다.',
      data: '부원별 기록부 — 주당 훈련 시간 · 하루 평균 수면 · 체지방률 · 부원 번호, 그리고 실제 <b>100m 기록(초)</b>',
      ask: '부원의 조건으로 <b>100m 기록(초)</b>이 얼마나 나올지 예측하기',
    },
    brief: [
    ...
    predictWhat: '부원의 조건으로 <b>100m 기록(초)</b>이 얼마나 나올지',
  ...
  /* ═══════ 확장 ③: 군집 · 경영/마케팅 ═══════ */
  {
    ...
    mlNeeded: true,
    dossier: {
      org: '🛍️ 한가득 분식 · 단골 만들기 프로젝트',
      scene: '동네에서 사랑받는 한가득 분식. 멤버십을 운영한 지 꽤 되어 <b>고객별 이용 기록</b>이 제법 쌓였습니다. 사장님의 고민은 "손님마다 성향이 다른 것 같은데, 다들 똑같은 쿠폰을 받으니 효과가 별로"라는 것. 비슷한 손님끼리 묶어 그룹마다 어울리는 이벤트를 하고 싶지만, <b>누가 어떤 유형인지 알려주는 정답표는 없습니다.</b>',
      data: '고객별 멤버십 기록 — 월 방문 횟수 · 월 구매액 · 마지막 방문 후 경과일 · 멤버십 번호 <b>(※ 유형 정답표 없음)</b>',
      ask: '비슷한 고객끼리 <b>그룹으로 묶어</b> 그룹별 맞춤 이벤트 찾기',
    },
    brief: [
